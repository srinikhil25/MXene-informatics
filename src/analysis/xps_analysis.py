...
XPS_REFERENCES = {
    "Ti 2p": {
        ...
        "components": [
            {"name": "Ti-C", "be_range": (454.5, 455.5), "typical_be": 455.0,
             ...
             "reference": "Halim et al., Chem. Mater. 2014, 26, 2374",
             "doi": "https://doi.org/10.1021/cm500641a"},
            {"name": "Ti(II)", "be_range": (455.5, 456.5), "typical_be": 455.8,
             "description": "Ti²⁺ from partial oxidation or Ti-OH",
             "reference": "Halim et al., Chem. Mater. 2014, 26, 2374",
             "doi": "https://doi.org/10.1021/cm500641a"},
            {"name": "Ti(III)", "be_range": (456.5, 458.0), "typical_be": 457.0,
             "description": "Ti³⁺ from surface -OH/-O termination",
             "reference": "Natu et al., Matter 2021, 4, 1224",
             "doi": "https://doi.org/10.1016/j.matt.2021.01.015"},
            {"name": "TiO₂", "be_range": (458.0, 459.5), "typical_be": 458.7,
             "description": "Ti⁴⁺ from TiO₂ surface oxide",
             "reference": "Diebold, Surf. Sci. Rep. 2003, 48, 53",
             "doi": "https://doi.org/10.1016/S0167-5729(02)00100-0"},
            {"name": "Ti-F", "be_range": (459.5, 461.0), "typical_be": 460.0,
             "description": "Ti bonded to F termination",
             "reference": "Persson et al., 2D Mater. 2018, 5, 015002",
             "doi": "https://doi.org/10.1088/2053-1583/aa89cd"},
            # Ti 2p₁/₂ spin-orbit components
            {"name": "Ti-C (2p₁/₂)", "be_range": (460.0, 461.5), "typical_be": 460.7,
             "description": "Spin-orbit pair of Ti-C (2p₃/₂), ΔE=5.7 eV",
             "reference": "Halim et al., Chem. Mater. 2014, 26, 2374",
             "doi": "https://doi.org/10.1021/cm500641a"},
            {"name": "Ti(II) (2p₁/₂)", "be_range": (461.0, 462.5), "typical_be": 461.5,
             "description": "Spin-orbit pair of Ti²⁺ (2p₃/₂), ΔE=5.7 eV",
             "reference": "Halim et al., Chem. Mater. 2014, 26, 2374",
             "doi": "https://doi.org/10.1021/cm500641a"},
            {"name": "Ti(III) (2p₁/₂)", "be_range": (462.0, 464.0), "typical_be": 462.7,
             "description": "Spin-orbit pair of Ti³⁺ (2p₃/₂), ΔE=5.7 eV",
             "reference": "Natu et al., Matter 2021, 4, 1224",
             "doi": "https://doi.org/10.1016/j.matt.2021.01.015"},
            {"name": "TiO₂ (2p₁/₂)", "be_range": (463.5, 465.5), "typical_be": 464.4,
             "description": "Spin-orbit pair of TiO₂ (2p₃/₂), ΔE=5.7 eV",
             "reference": "Diebold, Surf. Sci. Rep. 2003, 48, 53",
             "doi": "https://doi.org/10.1016/S0167-5729(02)00100-0"},
            {"name": "Ti-F (2p₁/₂)", "be_range": (465.0, 467.0), "typical_be": 465.7,
             "description": "Spin-orbit pair of Ti-F (2p₃/₂), ΔE=5.7 eV",
             "reference": "Persson et al., 2D Mater. 2018, 5, 015002",
             "doi": "https://doi.org/10.1088/2053-1583/aa89cd"},
        ],
    },
    "C 1s": {
        "components": [
            {"name": "Ti-C-Tₓ", "be_range": (281.0, 283.0), "typical_be": 282.0,
            ...
            {"name": "C-C/C=C", "be_range": (284.0, 285.5), "typical_be": 284.8,
             ...
             "reference": "Barr & Seal, J. Vac. Sci. Technol. A 1995, 13, 1239",
             "doi": "https://doi.org/10.1116/1.579868"},
            {"name": "C-O", "be_range": (285.5, 287.0), "typical_be": 286.4,
             "description": "C-O bonds (surface contamination)",
             "reference": "Beamson & Briggs, High Resolution XPS of Organic Polymers, 1992",
             "doi": "https://doi.org/10.1002/sia.740210116"},
    ...
    "O 1s": {
        "components": [
            {"name": "TiO₂", "be_range": (529.0, 530.5), "typical_be": 529.8,
             "description": "Lattice oxygen in TiO₂",
             "reference": "Diebold, Surf. Sci. Rep. 2003, 48, 53",
             "doi": "https://doi.org/10.1016/S0167-5729(02)00100-0"},
            {"name": "Ti-OH/C=O", "be_range": (530.5, 532.0), "typical_be": 531.2,
             ...
             "reference": "Natu et al., Matter 2021, 4, 1224",
             "doi": "https://doi.org/10.1016/j.matt.2021.01.015"},
            {"name": "C-O/Ti-OH₂", "be_range": (532.0, 533.5), "typical_be": 532.5,
             "description": "C-O bonds or adsorbed water on Ti",
             "reference": "Persson et al., 2D Mater. 2018, 5, 015002",
             "doi": "https://doi.org/10.1088/2053-1583/aa89cd"},
            {"name": "H₂O(ads)", "be_range": (533.5, 535.0), "typical_be": 533.8,
             "description": "Adsorbed water",
             "reference": "Yamamoto et al., J. Phys. Chem. C 2008, 112, 7435",
             "doi": "https://doi.org/10.1021/jp077396l"},
        ],
    },
    "F 1s": {
        "components": [
            ...
            {"name": "Al-F", "be_range": (686.0, 687.5), "typical_be": 686.5,
             "description": "AlF₃ residue from etching",
             "reference": "Natu et al., Matter 2021, 4, 1224",
             "doi": "https://doi.org/10.1016/j.matt.2021.01.015"},
...
def deconvolve_xps(binding_energy, intensity, element,
    ...
    for pos in initial_positions:
        ...
        # GL fraction is constrained to ±0.05 of user value so the
        # slider actually controls the peak shape visually.
        gl_lo = max(0.0, gl_fraction - 0.05)
        gl_hi = min(1.0, gl_fraction + 0.05)
        p0.extend([amp_guess, pos, 1.2, gl_fraction])
        lower.extend([0, pos - 2.0, min_fwhm, gl_lo])
        upper.extend([y.max() * 3, pos + 2.0, max_fwhm, gl_hi])
